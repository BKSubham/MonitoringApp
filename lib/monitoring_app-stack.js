...
//importing metric constants
const {METRICS_NAMESPACE, METRIC_AVAILABILITY, METRIC_LATENCY, AVAILABILITY_THRESHOLD, LATENCY_THRESHOLD} = require("./metric")
...
class MonitoringAppStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const websiteListPath = path.join(__dirname,'../lambda/website.json');
    ...
    websites.forEach((website) => {
        ...
        new cloudwatch.Alarm(this, `AvailabilityAlarm-${website}`, {
          ...
          alarmDescription: `Alarm when ${website} availability drops below 90%`,
          actionsEnabled: true
        });
